...
def test_kimi_k3_encoder_dp_defers_feature_materialization(monkeypatch):
    ...
    with mock_patch(
        ...
        # The IPC consumer count asks for the configured TP size, which reads
        # the parallel bag rather than the live topology stand-in above.
        "sglang.srt.models.kimi_k3.configured_tp_size",
        return_value=1,
    ):
